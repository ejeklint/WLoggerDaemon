...
#define DEFAULT_CLIENT_NAME     @"WLogger"
#define DEFAULT_CLIENT_VERSION  @"0.1"
#define DEFAULT_CLIENT_URL      @"http://www.ejeklint.se/development/wmr100n-driver-for-mac-os-x"
#define DEFAULT_CLIENT_TOKEN	@"wlogger"
